<div class="container">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            ...
            <img src="<?= base_url("img/hubungi/$content->photo") ?>" height="150">
            <?php else: ?>
            <p>No Photo</p>
            <?php endif; ?>
            <br>
    ...
    <div class="row mt-4">
        <div class="col-8 offset-2">
            <a href="<?= base_url('hubungi') ?>" class="btn btn-sm btn-secondary"><i
                    class="fas fa-angle-left mr-1"></i>Kembali</a>
            <button type="submit" class="btn btn-sm btn-primary float-right"><i class="fas fa-check mr-1"></i>
                Simpan</button>
        </div>
    </div>
    <?= form_close() ?>
