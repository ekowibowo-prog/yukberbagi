...
<div class="jumbotron banner_area jumbotron-fluid"
    ...
    <div class="container">
        <h1 class="display-4 my-auto text-dark text-center">Berita</h1>
    </div>
</div>
        ...
        <div class="row mt-4">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 my-3">
                <div class="card" style="width: 15rem; height: 24rem;">
                    <img style="height:150px" src="<?= base_url('img/berita/thumbs/' . $n->photo) ?>"
                        class="card-img-top">
                    <div class="card-body">
                        <h5 class="card-title"><?= $n->title ?></h5>
                        <p class="card-text"><?= character_limiter($n->content,50) ?></p>
                        <a href="<?= base_url("blog/baca/$n->seo_title") ?>" class="btn btn-info btn-sm">Lanjut
